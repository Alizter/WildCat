...
#[export] Hint Extern 1 (@IsFunctor1 ?m (Hom _ _ _) _ _ _ _ _ _ _ _ _) => change_dim m : typeclass_instances.
#[export] Hint Extern 1 (@IsFunctor1 ?m (Hom _ _ _) _ _ _ _ _ _ _ _ _) => change_dim_0 m : typeclass_instances.
#[export] Hint Extern 1 (@IsFunctor1 _ _ ?n _ _ _ _ _ _ _ _) => change_dim n : typeclass_instances.
#[export] Hint Extern 1 (@IsFunctor1 _ _ ?n _ _ _ _ _ _ _ _) => change_dim_0 n : typeclass_instances.
...
#[export] Hint Extern 1 (IsCat1 ?n _) => change_dim n : typeclass_instances.
#[export] Hint Extern 1 (IsCat1 ?n _) => change_dim_0 n : typeclass_instances.
...
Local Fixpoint cate_compose_temp {n : nat} `{IsCat1 n A}
  ...
  : a $<~> c
with cate_fmap_temp {m n : nat} {A : Type(* COQBUG(https://github.com/coq/coq/issues/14057)*)} `{HasEquivs@{bug14057_1 bug14057_2 bug14057_3 bug14057_4} m A} {B : Type(* COQBUG(https://github.com/coq/coq/issues/14057)*)} `{IsCat1@{bug14057_5 bug14057_6 bug14057_7 bug14057_8} n B}
