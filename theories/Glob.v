...
#[export] Hint Extern 1 (IsGlob ?n (Hom _ _ _)) => change_dim n : typeclass_instances.
#[export] Hint Extern 1 (IsGlob ?n (Hom _ _ _)) => change_dim_0 n : typeclass_instances.
...
#[export] Hint Extern 1 (IsDGlob ?n _) => change_dim n : typeclass_instances.
#[export] Hint Extern 1 (IsDGlob ?n _) => change_dim_0 n : typeclass_instances.
#[export] Hint Extern 1 (@IsDGlob ?m (Hom _ _ _) _ _ _) => change_dim m : typeclass_instances.
#[export] Hint Extern 1 (@IsDGlob ?m (Hom _ _ _) _ _ _) => change_dim_0 m : typeclass_instances.
...
#[export] Hint Extern 1 (@IsCatSect0 ?m (Hom _ _ _) _ _ _ _ _) => change_dim m : typeclass_instances.
#[export] Hint Extern 1 (@IsCatSect0 ?m (Hom _ _ _) _ _ _ _ _) => change_dim_0 m : typeclass_instances.
#[export] Hint Extern 1 (@IsCatSect0 _ _ ?n _ _ _ _) => change_dim n : typeclass_instances.
#[export] Hint Extern 1 (@IsCatSect0 _ _ ?n _ _ _ _) => change_dim_0 n : typeclass_instances.
...
#[export] Hint Extern 1 (@IsFunctor0 _ _ ?n _ _ _ _) => change_dim n : typeclass_instances.
#[export] Hint Extern 1 (@IsFunctor0 _ _ ?n _ _ _ _) => change_dim_0 n : typeclass_instances.
#[export] Hint Extern 1 (@IsFunctor0 ?m (Hom _ _ _) _ _ _ _ _) => change_dim m : typeclass_instances.
#[export] Hint Extern 1 (@IsFunctor0 ?m (Hom _ _ _) _ _ _ _ _) => change_dim_0 m : typeclass_instances.
...
#[export] Hint Extern 1 (@IsDFunctor0 ?m1 _ _ _ _ _ _ _ _ _ _ _ _ _ _) => change_dim m1 : typeclass_instances.
#[export] Hint Extern 1 (@IsDFunctor0 ?m1 _ _ _ _ _ _ _ _ _ _ _ _ _ _) => change_dim_0 m1 : typeclass_instances.
#[export] Hint Extern 1 (@IsDFunctor0 _ _ ?n1 _ _ _ _ _ _ _ _ _ _ _ _) => change_dim n1 : typeclass_instances.
#[export] Hint Extern 1 (@IsDFunctor0 _ _ ?n1 _ _ _ _ _ _ _ _ _ _ _ _) => change_dim_0 n1 : typeclass_instances.
#[export] Hint Extern 1 (@IsDFunctor0 _ _ _ _ ?m2 _ _ _ _ _ _ _ _ _ _) => change_dim m2 : typeclass_instances.
#[export] Hint Extern 1 (@IsDFunctor0 _ _ _ _ ?m2 _ _ _ _ _ _ _ _ _ _) => change_dim_0 m2 : typeclass_instances.
#[export] Hint Extern 1 (@IsDFunctor0 _ _ _ _ _ _ ?n2 _ _ _ _ _ _ _ _) => change_dim n2 : typeclass_instances.
#[export] Hint Extern 1 (@IsDFunctor0 _ _ _ _ _ _ ?n2 _ _ _ _ _ _ _ _) => change_dim_0 n2 : typeclass_instances.
...
Defined.
#[export] Existing Instance isdglob_compose.
...
#[export] Hint Extern 1 (@CatTrunc _ ?m (Hom _ _ _) _) => change_dim m : typeclass_instances.
#[export] Hint Extern 1 (@CatTrunc _ ?m (Hom _ _ _) _) => change_dim_0 m : typeclass_instances.
